...
export default function ProfilePage() {
  ...
  const addTag = (value: string, field: 'skills' | 'languages' | 'achievements', clear: () => void) => {
  ...
  const removeTag = (value: string, field: 'skills' | 'languages' | 'achievements') => {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      ...
      setStatus('saved');
      setToast('Profile saved. Redirecting to profiles...');
      setTimeout(() => {
        setStatus('idle');
      ...
      <BackgroundImage imageIndex={3} overlay="gradient" overlayOpacity={0.8}>
        <div className="flex items-center justify-center">
          <div className="text-center">
            <h1 className="text-2xl font-bold text-[var(--text)] mb-4">Please sign in to create your profile</h1>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-12 animate-fade-up">
        <div className="mb-6 sm:mb-10">
          <h1 className="text-3xl sm:text-4xl font-bold mb-3">
            Build Your <span className="text-yellow-500">Founder Profile</span>
          </h1>
          <p className="text-[var(--text-muted)]">Show your skills and what you are building so we can match you accurately.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
          <div className="glass-card rounded-3xl p-4 sm:p-6 space-y-3 sm:space-y-4">
            ...
            <div>
              <label className="block text-sm font-medium text-[var(--text-muted)] mb-2">Alias (public display name)</label>
              <input
                type="text"
                value={form.alias}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <label className="block text-sm font-medium text-[var(--text-muted)] mb-2">Commitment Level</label>
                <select
            ...
            <div>
              <label className="block text-sm font-medium text-[var(--text-muted)] mb-2">Skills</label>
            ...
            <div>
              <label className="block text-sm font-medium text-[var(--text-muted)] mb-2">Languages</label>
              <div className="flex flex-col sm:flex-row gap-3">
                <input
                  type="text"
                  value={languageInput}
            ...
            <div>
              <label className="block text-sm font-medium text-[var(--text-muted)] mb-2">Startup Interest / Idea</label>
              <textarea
            ...
            <div>
              <label className="block text-sm font-medium text-[var(--text-muted)] mb-2">Personal Achievements</label>
              <div className="flex flex-col sm:flex-row gap-3">
                <input
                  type="text"
          ...
          <div className="glass-card rounded-3xl p-6 space-y-4">
            <h2 className="text-xl font-bold text-[var(--text)]">Contact Details (revealed after unlock)</h2>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-[var(--text-muted)] mb-2">Contact Email</label>
                <input
                  type="email"
              ...
              <div>
                <label className="block text-sm font-medium text-[var(--text-muted)] mb-2">Phone / WhatsApp</label>
                <input
                  type="text"
            ...
            <div>
              <label className="block text-sm font-medium text-[var(--text-muted)] mb-2">Photo URL (optional)</label>
              <input
                type="url"
                value={form.photoUrl}
              ...
              <p className="text-xs text-[var(--text-muted)] mt-2">
                Tip: upload your photo to Google Drive, Imgur, or Cloudinary and paste the direct image URL.
              </p>
            </div>
          </div>
